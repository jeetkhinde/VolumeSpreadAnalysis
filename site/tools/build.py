...
OUT = 'site/src/content'
FIGS_OUT = 'site/public/figures'
            ...
            if it['kind'] == 'fig':
                ...
                if i + 1 < len(items) and items[i + 1]['kind'] == 'line':
                    ...
                    if m:
                        ...
                        i += 1
                blocks.append({'t': 'figure', 'src': f'/figures/{it["f"]["file"]}',
                ...
                if cur is not None:
                    ...
                    if i + 1 < len(items) and items[i + 1]['kind'] == 'line':
                        ...
                        if m:
                            cap_label, cap_text = m.group(1), m.group(2)
                            i += 1
                    cur['blocks'].append({'t': 'figure', 'src': f'/figures/{it["f"]["file"]}',
                                          'label': cap_label, 'caption': cap_text})
                prev = None
                i += 1
                continue
